...
FFI bindings to MAME's CHD library for creating and extracting CD CHD images.
  ...
  # MAME chd sources are added: to enable real CD support on macOS, add
  # '../src/chd/**/*.{c,cpp}' to source_files below and append
  # '-DCHDMAN_AVAILABLE=1' to the xcconfig, then vendor the sources per
  # src/chd/PLACEHOLDER.md.
