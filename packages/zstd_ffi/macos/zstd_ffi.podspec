...
FFI bindings to the native Zstandard (libzstd) streaming compression API.
  ...
  # libzstd sources are added: to enable real compression on macOS, add the
  # zstd lib sources to source_files, add '../src/zstd/lib' to header search
  # paths, and append '-DZSTD_AVAILABLE=1' to the xcconfig, then vendor the
  # sources per src/zstd/PLACEHOLDER.md.
